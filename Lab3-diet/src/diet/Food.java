...
public class Food {		
	...
	private final SortedMap<String, NutritionalElement> rawMaterials = new TreeMap<>();
	private final SortedMap<String, NutritionalElement> products = new TreeMap<>();
	private final SortedMap<String, NutritionalElement> recipes = new TreeMap<>();
