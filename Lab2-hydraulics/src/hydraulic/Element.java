...
public abstract class Element {
	...
	public void setMaxFlow(double maxFlow) {
	 ...
	 /**
     * Simulates the behavior of this element given the input flow.
     * It must notify the observer with the appropriate input/output flows.
     * 
     * @param observer the simulation observer
     * @param inFlow the input flow
     */
    public void simulate(SimulationObserver observer, double inFlow, boolean enableMaxFlowCheck) {
    	simulate(observer, inFlow,enableMaxFlowCheck); 
	}
